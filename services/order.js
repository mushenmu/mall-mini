...
function commitOrder(params) {
  return post('/api/order/commit', params);
}
...
function payOrder(uid, orderNo) {
  return post('/api/order/pay', { uid, orderNo });
}

// 取消订单
function cancelOrder(uid, orderNo) {
  return post('/api/order/cancel', { uid, orderNo });
}

// 确认收货
function confirmOrder(uid, orderNo) {
  return post('/api/order/confirm', { uid, orderNo });
}
